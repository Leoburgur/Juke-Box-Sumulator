...
vending_main.title("Marvelous Mini Musicie Machine")
...
options = {'Rick roll': '50p', 'Your gonna go far kid': '20p', 'Fart': '10p', 'Buddy holly': '5p', 'Bong': '3p'}
message = ['insert a coin', 'choose a song', 'coin accepted', 'current balance: ', 'Transaction cancelled']
# ============================================
#: 2.2 Functions
...
def update_options():
    candy_list = []
    if balance >= 50:
        candy_list.extend(['Rick roll', 'Your gonna go far kid', 'Fart', 'Buddy holly', 'Bong'])
        dropdown_menu.set('')
    elif balance >= 20:
        candy_list.extend(['Your gonna go far kid', 'Fart', 'Buddy holly', 'Bong'])
        dropdown_menu.set('')
    elif balance >= 10:
        candy_list.extend(['Fart', 'Buddy holly', 'Bong'])
        dropdown_menu.set('Fart')
    elif balance >= 5:
        candy_list.extend(['Buddy holly', 'Bong'])
        dropdown_menu.set('')
    elif balance >= 3:
        candy_list.extend(['Bong'])
        dropdown_menu.set('')
    else:
        candy_list.extend([''])
    ...
    if balance <= 0:
        ...
        button_cancel.configure(text='Cancel', command=lambda: close())
...
def status_candy():
    if dropdown_menu.get() == 'Buddy holly':
        playsound('/home/leonardschwartz/Desktop/Personal/Codeing/Python/Juke-box/Holly.mp3')
    elif dropdown_menu.get() == 'Rick roll':
        playsound('/home/leonardschwartz/Desktop/Personal/Codeing/Python/Juke-box/Rick.mp3')
    elif dropdown_menu.get() == 'Fart':
        playsound('/home/leonardschwartz/Desktop/Personal/Codeing/Python/Juke-box/Fart.mp3')
    elif dropdown_menu.get() == 'Your gonna go far kid':
        playsound('/home/leonardschwartz/Desktop/Personal/Codeing/Python/Juke-box/Kid.mp3')
    elif dropdown_menu.get() == 'Bong':
        playsound('/home/leonardschwartz/Desktop/Personal/Codeing/Python/Juke-box/BONG.mp3')
    messagebox.showinfo('Played song', f'Current balance:{balance}p')

def close():
    messagebox.showinfo('Transaction Complete', 'Thank you.')
    playsound('/home/leonardschwartz/Desktop/Personal/Codeing/Python/Juke-box/ching.mp3')
...
prices = Label(left_frame, text='RICK ROLL | 50p\nFAR KID | 20p\n'
                                'FART | 10p\nBUDDY | 5p\nBONG | 3p\n_________', font=t_h1,
